...
fn test_timezones_weekly() {
    ...
    const LOS_ANGELES: Tz = Tz::from_static(chrono_tz::America::Los_Angeles);
    const NEW_YORK: Tz = Tz::from_static(chrono_tz::America::New_York);
    const BERLIN: Tz = Tz::from_static(chrono_tz::Europe::Berlin);
